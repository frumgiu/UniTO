...
public class Modificato {
        ...
        public Modificato(Lexer l, BufferedReader br) {
            lex = l;
            pbr = br;
            move();
        }
        ...
        private void whenlist(/*int wl_next,*/ int wl_true)
        {
            switch (look.tag) {
                case Tag.WHEN:
                    whenitem(wl_true);
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                Modificato translator = new Modificato(lex, br);
                translator.prog();
